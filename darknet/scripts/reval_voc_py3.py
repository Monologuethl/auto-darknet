...
def parse_args():
    ...
    parser.add_argument('output_dir', nargs=1, help='results directory',
                        type=str)
    parser.add_argument('--voc_dir', dest='voc_dir', default='/home/techik/Project/DATASET/VOCdevkit', type=str)
    ...
    parser.add_argument('--classes', dest='class_file', default='../data/huasheng.names', type=str)
